  ...
  return (
    <div className="bg-white min-h-screen flex flex-col justify-center items-center">
      <div className="w-screen h-screen max-w-md p-6">
        ...
        <img src="iconEmail.svg" alt="Email icon" className="mx-auto mb-4" />
        <h2 className="text-lg font-semibold mb-2 text-center">
          Masukkan Kode Verifikasi
        </h2>
        <p className="text-gray-500 mb-4 text-center text-sm">
          Kode verifikasi telah kami kirim melalui email.
        </p>
          ...
          <div className="flex justify-center space-x-2 mb-4">
            {otpCode.map((code, index) => (
              <input
                ...
                className={`border-b-2 text-2xl font-semibold w-10 text-center ${
        ...
        <p className="text-gray-500 text-sm text-center">
          Tidak menerima kode?
          {isResendDisabled ? (
            `Mohon tunggu ${countdown} detik untuk mengirim ulang kode.`
          ) : (
            <button
