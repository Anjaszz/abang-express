...
const HomePage = () => {
  ...
  return (
    <div className="bg-white h-screen mb-80">
      <div className="bg-red-500 text-white text-center py-4 relative h-36 ">
        <img
          src="city.svg"
          alt="City"
          className="absolute inset-0 w-full h-full object-bottom object-contain"
        />
        <h1 className="text-sm relative z-10 top-10">Abang Express</h1>
        <h2 className="text-xl font-bold relative z-10 top-11">
          Agen Jogjakarta
        </h2>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 mx-4 mt-4">
        ...
        <div
          className="bg-white shadow-md rounded-xl p-3 flex items-center"
          onClick={() => handleTabClick("Trouble")}
        >
          <div className="flex items-center justify-center mb-2 bg-red-100 p-2 rounded-lg">
            <img
              src="Truck/Trouble.svg"
              alt="Trouble Icon"
              className="w-8 h-8"
            />
          </div>
      ...
      <div className="mx-4 mt-8">
        ...
        <div
          className="bg-white shadow-md rounded-xl p-4 mt-4"
          onClick={() => handleTabClick("Pending")}
        >
          <div className="flex justify-between items-center">
            <div className="flex items-center">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-2">
                ...
                <div className="text-gray-500 text-xs">
                  Jl. Ampera Raya No. 133, RT.05/RW.10, Ragunan, Kec. Ps.
                  Minggu, Kota Jakarta...
                </div>
              </div>
            </div>
